...
switch ($_SESSION['id']) {
    ...
    case 2:?>
        <aside>
            <ul>
                <li><i class="fa fa-home"></i><a href="<?= HTTP_PATH . 'public//views/dashboards/sales.php' ?>">Dashboard</a></li>
                <li><i class="fa fa-users"></i><a href="<?= HTTP_PATH . 'public/views/customers/overview.php' ?>">Custommers</a></li>
                <li><i class="fa fa-tasks"></i><a href="<?= HTTP_PATH . 'public/views/projects/overview.php' ?>">Projects</a></li>
                <li><i class="fa fa-pencil-square-o"></i><a href="<?= HTTP_PATH . 'public/views/invoices/overview.php' ?>">Invoices</a></li>
                <li><i class="fa fa-paperclip"></i><a href="<?= HTTP_PATH . 'public/views/appointments/salesAppointments.php' ?>">Appointments</a></li>
            </ul>
    ...
    case 3:?>
        <aside>
            <ul>
                <li><i class="fa fa-home"></i><a href="<?= HTTP_PATH . 'public//views/dashboards/finance.php' ?>">Dashboard</a></li>
                <li><i class="fa fa-users"></i><a href="<?= HTTP_PATH . 'public/views/customers/overview.php' ?>">Custommers</a></li>
                <li><i class="fa fa-tasks"></i><a href="<?= HTTP_PATH . 'public/views/projects/overview.php' ?>">Projects</a></li>
                <li><i class="fa fa-pencil-square-o"></i><a href="<?= HTTP_PATH . 'public/views/invoices/overview.php' ?>">Invoices</a></li>
                <li><i class="fa fa-paperclip"></i><a href="<?= HTTP_PATH . 'public/views/appointments/financeAppointments.php' ?>">Appointments</a></li>
            </ul>
    ...
    case 4:?>
        <aside>
            <ul>
                <li><i class="fa fa-home"></i><a href="<?= HTTP_PATH . 'public//views/dashboards/development.php' ?>">Dashboard</a></li>
                <li><i class="fa fa-tasks"></i><a href="<?= HTTP_PATH . 'public/views/projects/overview.php' ?>">Projects</a></li>
                <li><i class="fa fa-paperclip"></i><a href="<?= HTTP_PATH . 'public/views/appointments/developmentAppointments.php' ?>">Appointments</a></li>
            </ul>
